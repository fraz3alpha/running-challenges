...
cp -r js/lib/third-party/leaflet website/assets/css/third-party/
cp -r js/lib/third-party/leaflet-extramarkers website/assets/css/third-party/
cp -r js/lib/third-party/leaflet-fullscreen website/assets/css/third-party/
cp -r js/lib/third-party/leaflet-markercluster website/assets/css/third-party/
